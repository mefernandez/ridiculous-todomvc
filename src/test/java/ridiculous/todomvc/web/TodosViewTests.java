...
@WebAppConfiguration
@ContextConfiguration("TodosViewTests-config.xml")
@ActiveProfiles("jdbc")
public class TodosViewTests {
    ...
    @Test
    public void shouldShowEntriesOnStartUp() throws Exception {
        ResultActions actions = this.mockMvc.perform(get("/todos").accept(MediaType.TEXT_HTML));
